...
-- Wed 29 Oct 2014 11:48:16 AM CET
...
-- Table `ProtClust`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClust` ;
...
-- Table `ProtClustXRef`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClustXRef` ;

CREATE TABLE IF NOT EXISTS `ProtClustXRef` (
  `Id` VARCHAR(50) NOT NULL,
  `ProtClust_WID` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ProtClustProteins`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClustProteins` ;

CREATE TABLE IF NOT EXISTS `ProtClustProteins` (
  `GeneGi` BIGINT NULL,
  `LocusName` VARCHAR(45) NULL,
  `ProteinGi` BIGINT NULL,
  `ProteinName` VARCHAR(255) NULL,
  `ProtClust_WID` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ProtClust_has_GeneInfo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClust_has_GeneInfo` ;
...
-- -----------------------------------------------------
-- Table `ProtClust_has_Protein`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClust_has_Protein` ;
...
-- -----------------------------------------------------
-- Table `ProtClust_has_Taxonomy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClust_has_Taxonomy` ;
...
-- Table `ProtClustPMID`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClustPMID` ;
...
-- -----------------------------------------------------
-- Table `ProtClust_has_COGOrthologousGroup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClust_has_COGOrthologousGroup` ;
...
-- Table `ProtClustEC`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProtClustEC` ;
...
-- -----------------------------------------------------
-- Table `DrugBankTargetPolypeptide`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DrugBankTargetPolypeptide` ;
...
-- -----------------------------------------------------
-- Table `DrugBankEnzymePolypeptide`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DrugBankEnzymePolypeptide` ;
...
-- -----------------------------------------------------
-- Table `DrugBankTransporterPolypeptide`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DrugBankTransporterPolypeptide` ;
...
-- -----------------------------------------------------
-- Table `DrugBankCarrierPolypeptide`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DrugBankCarrierPolypeptide` ;
