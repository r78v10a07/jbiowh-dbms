...
CREATE  TABLE IF NOT EXISTS `Gene2Accession` (
  ...
  PRIMARY KEY (`WID`, `GeneInfo_WID`) ,
  INDEX `fk_Gene2Accession_GeneInfo1_idx` (`GeneInfo_WID` ASC) ,
  INDEX `pk_RNANuclotideAccession` (`RNANucleotideAccession` ASC) ,
  INDEX `pk_RNANuclotideGi` (`RNANucleotideGi` ASC) ,
  INDEX `pk_ProteinAccession` (`ProteinAccession` ASC) ,
  INDEX `pk_ProteinGi` (`ProteinGi` ASC) ,
  INDEX `pk_GenomicNucleotideAccession` (`GenomicNucleotideAccession` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `GenomesPTT` (
  ...
  INDEX `fk_GenomesPTT_Gene2Accession_idx` (`ProteinGi` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `Gene2Accession_has_Protein` (
  ...
  INDEX `fk_Gene2Accession_has_Protein_Protein1_idx` (`Protein_WID` ASC) ,
  INDEX `fk_Gene2Accession_has_Protein_Gene2Accession1_idx` (`ProteinGi` ASC) )
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
CREATE  TABLE IF NOT EXISTS `GeneInfo_has_GenomesPTT` (
  ...
  INDEX `fk_GeneInfo_has_GenomesPTT_GenomesPTT1_idx` (`GenomesPTT_ProteinGi` ASC) ,
  INDEX `fk_GeneInfo_has_GenomesPTT_GeneInfo1_idx` (`GeneInfo_WID` ASC) )
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
