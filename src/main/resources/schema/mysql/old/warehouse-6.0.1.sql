...
-- Table `OrthoXML`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXML` ;

CREATE TABLE IF NOT EXISTS `OrthoXML` (
...
-- Table `OrthoXMLGroup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLGroup` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLGroup` (
  `WID` BIGINT(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `OrthoXMLSpecie`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLSpecie` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLSpecie` (
  `WID` BIGINT(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `OrthoXMLSpeciesDatabase`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLSpeciesDatabase` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLSpeciesDatabase` (
  `WID` BIGINT(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `OrthoXMLSpeciesDatabaseGene`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLSpeciesDatabaseGene` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLSpeciesDatabaseGene` (
...
-- -----------------------------------------------------
-- Table `OrthoXMLGroupGeneRef`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLGroupGeneRef` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLGroupGeneRef` (
  `WID` BIGINT(20) NOT NULL,
  `Id` INT(11) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `OrthoXMLGroupGeneRefScore`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLGroupGeneRefScore` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLGroupGeneRefScore` (
...
-- -----------------------------------------------------
-- Table `OrthoXMLGroupProperty`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLGroupProperty` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLGroupProperty` (
  `Name` VARCHAR(255) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `OrthoXMLGroupScore`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLGroupScore` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLGroupScore` (
  `Id` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL,
  `Value` DECIMAL(10,0) NULL DEFAULT NULL,
  `OrthoXMLGroup_WID` BIGINT(20) NOT NULL,
...
-- Table `OrthoXMLScore`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OrthoXMLScore` ;

CREATE TABLE IF NOT EXISTS `OrthoXMLScore` (
...
-- -----------------------------------------------------
-- Table `COGFuncClassGroup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGFuncClassGroup` ;

CREATE TABLE IF NOT EXISTS `COGFuncClassGroup` (
  `WID` BIGINT NOT NULL,
...
-- Table `COGFuncClass`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGFuncClass` ;

CREATE TABLE IF NOT EXISTS `COGFuncClass` (
  `WID` BIGINT NOT NULL,
  `Letter` CHAR CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL,
  `Name` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL,
  `COGFuncClassGroup_WID` BIGINT NOT NULL,
  PRIMARY KEY (`WID`))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
-- -----------------------------------------------------
-- Table `COGOrthologousGroup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGOrthologousGroup` ;

CREATE TABLE IF NOT EXISTS `COGOrthologousGroup` (
  `WID` BIGINT NOT NULL AUTO_INCREMENT,
  `Id` VARCHAR(15) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL,
  `GroupFunction` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL,
  `DataSet_WID` BIGINT NOT NULL,
  PRIMARY KEY (`WID`),
...
-- Table `COGMember`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGMember` ;

CREATE TABLE IF NOT EXISTS `COGMember` (
  `COGOrthologousGroup_WID` BIGINT NOT NULL,
  `Organism` VARCHAR(10) NULL,
...
-- -----------------------------------------------------
-- Table `COGMember_has_Gi`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGMember_has_Gi` ;

CREATE TABLE IF NOT EXISTS `COGMember_has_Gi` (
  `Id` VARCHAR(15) NOT NULL,
  `Gi` BIGINT NOT NULL,
  PRIMARY KEY (`Id`, `Gi`))
ENGINE = MyISAM
...
-- -----------------------------------------------------
-- Table `COGMember_TaxId`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGMember_TaxId` ;

CREATE TABLE IF NOT EXISTS `COGMember_TaxId` (
...
-- -----------------------------------------------------
-- Table `COGOrthologousGroup_has_GeneInfo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGOrthologousGroup_has_GeneInfo` ;

CREATE TABLE IF NOT EXISTS `COGOrthologousGroup_has_GeneInfo` (
  `COGOrthologousGroup_WID` BIGINT NOT NULL,
  `GeneInfo_WID` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `COGOrthologousGroup_has_Protein`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGOrthologousGroup_has_Protein` ;

CREATE TABLE IF NOT EXISTS `COGOrthologousGroup_has_Protein` (
  `COGOrthologousGroup_WID` BIGINT NOT NULL,
  `Protein_WID` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `COGOrthologousGroup_has_Taxonomy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGOrthologousGroup_has_Taxonomy` ;

CREATE TABLE IF NOT EXISTS `COGOrthologousGroup_has_Taxonomy` (
  `COGOrthologousGroup_WID` BIGINT NOT NULL,
  `Taxonomy_WID` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `COGOrthologousGroup_has_COGFuncClass`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COGOrthologousGroup_has_COGFuncClass` ;

CREATE TABLE IF NOT EXISTS `COGOrthologousGroup_has_COGFuncClass` (
  `COGOrthologousGroup_WID` BIGINT NOT NULL,
  `COGFuncClass_WID` BIGINT NOT NULL,
...
-- Table `GeneBankCOG`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneBankCOG` ;

CREATE TABLE IF NOT EXISTS `GeneBankCOG` (
  `GeneBankCDS_WID` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `GeneBankCDSLocation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneBankCDSLocation` ;

CREATE TABLE IF NOT EXISTS `GeneBankCDSLocation` (
  `GeneBankCDS_WID` BIGINT NOT NULL,
  `pFrom` INT NOT NULL,
  `pTo` INT NULL,
