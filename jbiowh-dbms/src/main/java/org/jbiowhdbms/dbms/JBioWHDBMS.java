 ...
 * @since Oct 8, 2013
 */
public class JBioWHDBMS {

    private static JBioWHDBMS singleton;
    ...
    /**
     * Return a JBioWHDBMS instance
     *
     * @return a JBioWHDBMS instance
     */
    public static synchronized JBioWHDBMS getInstance() {
        if (singleton == null) {
            singleton = new JBioWHDBMS();
        }
        return singleton;
    }
    ...
    public WHDBMSFactory getWhdbmsFactory(String URL) {
        return connections.get(parseURL(URL));
    }

    public void setWhdbmsFactory(WHDBMSFactory whdbmsFactory) {
